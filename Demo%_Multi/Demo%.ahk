...
global screenDelay := 100 ; normal delay of each world creation screen, increase if random seeds are being created, decrease for faster resets
...
global centerPointX := -200 ; this is the x coordinate of that certain point (by default it's the x coordinate of being pushed up against the window of the blacksmith of -3294725893620991126)
global centerPointZ := -191 ; this is the z coordinate of that certain point (by default it's the z coordinate of being pushed up against the window of the blacksmith of -3294725893620991126)
global radius := 1000 ; if this is 10 for example, the autoresetter will not reset if you are within 10 blocks of the point specified above. Set this smaller for better spawns but more resets
...
global SEED := "-343522682" ; Default seed is the current Any% SSG 1.16+ seed, you can change it to whatever seed you want.
